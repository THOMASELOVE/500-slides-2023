...
- For all sessions, Dr. Love is available before and (especially) after class for informal "office hours".
- Recordings of sessions will be available through Zoom on Canvas when things work properly.

## The Web Site

<https://thomaselove.github.io/500-2023> is at the bottom of every slide
...
1. Course Project
    - Semester-long project, with your first proposal draft due 2023-02-22.
    - Final presentation of your work on 2023-04-27 or 2023-05-04.
2. Observational Studies in Action
    ...
    - First step is to identify a study and claim it by 2023-02-15.
3. Labs
    - Lab 01 is due Wednesday 2023-02-01 at 7 PM
    - There is a "Lab 0" worked example.
    - Deadlines and instructions for all 5 labs are on the website.
4. Essays reacting to Rosenbaum's *Observation & Experiment*
    - Readings detailed in Calendar (Preface, Chapters 1-2 by next week.)
    - I'll decide on Essays later in the term.
...
## Next Class - Thursday 2023-01-26
